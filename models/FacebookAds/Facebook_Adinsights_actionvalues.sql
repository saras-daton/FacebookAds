...
{% for i in results_list %}
    ...
    From (
        ...
        action_values.VALUE:"1d_click"::VARCHAR as click_1d,
        action_values.VALUE:"1d_view"::VARCHAR as view_1d,
        action_values.VALUE:"28d_click"::VARCHAR as click_28d,
        action_values.VALUE:"28d_view"::VARCHAR as view_28d,
        action_values.VALUE:"7d_click"::VARCHAR as click_7d,
        action_values.VALUE:"7d_view"::VARCHAR as view_7d,
        ...
        {% else %}
        action_values._daton_pre_1d_click as click_1d,
        action_values._daton_pre_1d_view as view_1d,
        action_values._daton_pre_28d_click as click_28d,
        action_values._daton_pre_28d_view as view_28d,
        action_values._daton_pre_7d_click as click_7d,
        action_values._daton_pre_7d_view as view_7d,
