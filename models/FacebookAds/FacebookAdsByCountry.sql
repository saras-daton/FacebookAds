...
{{set_table_name('%facebookads%adinsights%country')}}    
{% endset %}  
...
{% for i in results_list %}
    ...
    FROM (
        ...
        video_play_actions.VALUE:_d_view as video_play_actions__d_view,
        {% else %}
        video_play_actions.action_type as video_play_actions_action_type,
        video_play_actions.values as video_play_actions_value,
        video_play_actions._d_view as video_play_actions__d_view,
        {% endif %}
