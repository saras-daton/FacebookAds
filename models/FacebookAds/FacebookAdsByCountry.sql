...
{% set result =set_table_name("fbads_by_country_tbl_ptrn","fbads_by_country_tbl_exclude_ptrn") %}
...
{% for i in result %}
        ...
        FROM  {{i}} a
                ...
                {% endif %}    
        qualify ROW_NUMBER() OVER (PARTITION BY ad_id,date_start,country order by a.{{daton_batch_runtime()}} desc) = 1  
